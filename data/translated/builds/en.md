...
On a Hybrid build where Albedo casts his Elemental Burst, this weapon can be a better option than Cinnabar Spindle on certain situations, such as AoE where Albedo's Burst hits multiple enemies or when there are external ATK buffs like Bennett's Burst. On a pure Elemental Skill focused Albedo or Single Target situations for Hybrid Albedo, Cinnabar Spindle is the better option, so choose wisely.
...
Use Charged Attacks if you're going to be doing Vaporize DPS, Normal Attacks are for Electro-Charge DPS.<br>
...
**[Maiden Beloved (2) ](#artifact:maiden-beloved)+ [Tenacity of the Millelith (2)](#artifact:tenacity-of-the-millelith)**<br>
Acts as a place holder set for Maiden Beloved if you want pure healing and have not been able to gather Maiden Beloved (4) yet.

**[Noblesse Oblige (4)](#artifact:noblesse-oblige)**<br>
Usable option if you want Barbara to have more utility, but do note that Barbara might have bad uptime on this set.
...
This weapon can be considered over Wolf's Gravestone for a Sub DPS Beidou, while Wolf's Gravestone is equipped onto another Claymore DPS character with higher field time. Beidou can effectively make use of the full stacks, as long as you have her stacks up before swapped away, the stacks will be maintained even while off-field since her Elemental Burst snapshots her stats. **Serpent Spine outperforms Wolf's Gravestone by a significant margin when Bennett/Sara ATK buffs are applied.**
...
This set seeks to maximise your Burst damage in an Electro-Charged or mono Electro comps, take note that the set could be rendered useless when against enemies with non-Electro elements imbued.

**[Noblesse Oblige (4)](#artifact:noblesse-oblige)**<br>
This set could be considered if your Beidou can get her Elemental Burst off cooldown and the team doesn't have a Noblesse Oblige (4) user yet, do note that sometimes Beidou doesn't benefit from the ATK buff from the 4 piece set if she's the set holder, so Beidou as a Noblesse Oblige (4) holder isn't really recommended.
...
**[Tenacity of the Millelith (4)](#artifact:tenacity-of-the-millelith)**<br>
Works as a low/no investment Fischl build. This set trades off Fischl's damage in return for a party wide 20 ATK% buff. **Not recommended to specifically farm this set for Fischl.** Only use this set if you have pieces while farming for the Pale Flame set for your Physical DPSes.
...
[Crimson Witch of Flames (4)](#artifact:crimson-witch-of-flames)<br>
This set is best used on a Vaporize Klee, but do note that due to Klee's fast Pyro application from all of her kits, she may not be able to vape most of her Normal/ Charged Attacks.
...
With external ATK buffs assumed.

[Lost Prayers to the Sacred Winds](#weapon:lost-prayer-to-the-sacred-winds)<br>
A really good weapon with external ATK buffs considered due to having Crit Rate main stat. Even with 1 stack of passive, this weapon is highly competitive with the other top choices.

[Memory of Dust](#weapon:memory-of-dust)<br>
A really good ATK stat stick which performs better than the other 5 star options if you don't consider external ATK buffers like Bennett, Pyro resonance, etc, but falls off with it considered.

[The Widsith](#weapon:the-widsith)<br>
A bursty weapon which has a really great passive, however Ningguang can only benefit from 2 out of the 3 passives that this weapon provides; EM bonus on Ningguang is basically useless.

[Dodoco Tales](#weapon:dodoco-tales)<br>
Being an ATK weapon, it falls off if compared to the other 4 star options such as Solar Pearl and The Widsith with external ATK buffs considered, but can perform better without it considered.
...
[Lost Prayers to the Sacred Winds](#weapon:lost-prayer-to-the-sacred-winds)<br>
Falls off a bit if compared to Skyward Atlas due to not being able to stack the passive reliably, but it's still a Crit weapon which makes stat building much easier.

[Memory of Dust](#weapon:memory-of-dust)<br>
A really good ATK statstick which can perform better than the other options if you don't consider external ATK buffers like Bennett, Pyro resonance, etc, but falls off with it considered.
...
**Raiden's main stat priority for Sands and Goblet entirely depends on the substats, whether she has external buffs, and which weapon she is running.** You can find a more detailed list of [suggestions from ZΛNTO#4984's mastersheet here](https://docs.google.com/spreadsheets/d/1VdRUAKFUoKkceIghV5tCfr3kfoiH59mcFOMorI9jYrw/edit#gid=1372936118) or run it on a calculator/optimizer.
...
[Deathmatch](#weapon:deathmatch)<br>
Rosaria gets alot of Crit rate from **Blizzard Strayer (4) and Cryo Resonance.** As a result, this weapon falls off in value as you will tend to **overcap above 100% Crit rate.** If Rosaria is being used without the Blizzard Strayer (4) set, then this weapon can perform better compared to other options.
...
[Lavawalker's Epiphany (4)](#artifact:lavawalker)<br>
...
**The following is only recommended to those who have not obtained a desirable set for Rosaria, with Crit Rate building as her placeholder set.**<br>
...
This weapon can be useful if you need Sucrose's Elemental Burst up as often as possible for **grouping.** You may need to get a few crit rate substats to trigger the passive reliably.<br>
There are some team compositions in which Sucrose's Elemental Mastery is not a priority, such as Freeze teams or an Anemo battery for Xiao. In such situations it's better for Sucrose to use to [Thrilling Tales of the Dragon Slayers](#weapon:thrilling-tales-of-dragon-slayers).

**Regarding Energy Recharge Priority**

Ranking is based on the assumption that Sucrose has [Sacrificial Fragments](#weapon:sacrificial-fragments) and is not valued for her Burst in teams that may not want Sucrose's Burst interfering with elemental auras. Energy Recharge could be prioritized higher when Sucrose is utilized in teams that don't really mind which element is being applied first and last (e.g. Electro-charged).
...
**[The Stringless<br>
](#weapon:the-stringless)Main DPS Childe should only use this weapon in teams where you are Vaporising your Burst,** as the Elemental Mastery substat loses alot of value in other teams. If Childe is being used as a **Nuke Support only for his Vaporised Burst damage, R5 Stringless will rank just below Thundering Pulse.** Note that the stringless elemental skill passive does not affect Childe's melee stance auto attacks.
...
[Gladiator's Finale (2) Pale Flame (2)](#artifact:gladiators-finale)<br>
This set is ranked higher than Pale Flame (2) Bloodstained Chivalry (2) due to how much Geo Damage is in the Traveler's kit. If you truly prefer to have the highest physical damage output, use Set 2 instead.

[Pale Flame (4)<br>
](#artifact:pale-flame)**This set is not recommended** due to the Traveler's Elemental Skill cooldown being 6 seconds, which means the 4 piece set effect only kicks in 6 seconds into every rotation, and also gives the player a very little time window to keep up the 4 piece set effect.
...
Check out [this link](http://tinyurl.com/ventiburstinfo) to see which characters can hit the enemies sucked and ragdolled in Venti's burst. (Sheet has not been updated since Yanfei release)
...
Due to EM build assumptions, the stats offered aren't very valuable. Consider reading the In-depth Guide from KQM if you're interested in a Crit-focused build.
...
**[Crimson Witch (4)](#artifact:crimson-witch-of-flames)**<br>
This set pulls ahead over Emblem of Severed Fate (4) on team comps where Xiangling triggers Overloads in addition to Vaporise (i.e. Raiden National).
...
When Xingqiu is **\[C6\],** Mistsplitter and Jade Cutter has the best damage potential given enough ER (170-190%), Skyward Blade has the second best damage potential (same ER requirement as Jade), and Sacrificial Sword has the third best damage potential.
...
[Serpent Spine](#weapon:serpent-spine)<br>
It is worth noting that an **\[R5\] Serpent Spine** can outperform all 5 star weapons at **\[R1\]** with proper stack management
...
[Kitain Cross Spear](#weapon:kitain-cross-spear)<br>
Although the EM mainstat isn't useful for Yun Jin, the **passive decreases her Energy Recharge requirements** by alot, especially at higher refinements. **It can reduce her ER% reqs from around \~20% at R1 to \~70% at R5.** Note that **she must cast Elemental Burst first before Skill, as the passive drains 3 energy initially when Skill is cast.** If you only care about the Energy Recharge, this weapon can be left at level 1 while still getting full effect from the passive.
