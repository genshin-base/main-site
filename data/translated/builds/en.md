...
Forcing to get Polar Star stacks isn't worth due to consuming extra time to get those stacks.
...
Assumes the passive is active by proccing a weak point shot. This weapon especially at higher refinement levels can be as good as Skyward Harp.
...
Assuming 260 team energy, Akuoumaru outperforms **Skyward Pride** on a **low ER requirement Beidou** (where she is paired with other Electro characters to battery her energy needs). At **\[R3+\],** it becomes exponentially better and comes very close to **Serpent Spine** and **Wolf's Gravestone.**
...
**[The Black Sword](#weapon:the-black-sword)**
With the EM sand, this combo has the highest Melt/Vaporize damage. <br>
...
[Whiteblind](#weapon:whiteblind)<br>
...
**[+25% Physical DMG set ](#25%-ph-atk)+ [Bloodstained Chivalry (2)](#artifact:bloodstained-chivalry)**<br>
This set should only be used until getting Pale Flame (4).

**[+25% Physical DMG set ](#25%-ph-atk)+ [18% ATK set (2)](#artifact:18%-atk)**<br>
...
Aim for around 850-950+ Elemental Mastery. Depending on whether you use a Elemental Mastery weapon or not.
...
[Thundering Fury (4)](#artifact:thundering-fury)
Only really a consideration if you have a completed set of it already, with a higher number of Elemental Mastery substat rolls, or as a placeholder set while you farm other sets.
...
**[Tenacity of the Millelith (4)](#artifact:tenacity-of-the-millelith)**<br>
This set acts as a low investment support oriented set. Raiden is an excellent ToTM holder since her Elemental Skill has 100% uptime and procs very easily. Do note that if your Raiden is equipping this set, then she will sacrifice her personal damage.
...
**[Wolf's Gravestone](#weapon:wolfs-gravestone)**<br>
...
**[The Unforged](#weapon:the-unforged)**<br>
The playstyle with this weapon becomes a lot more comfortable without having to worry about snapshotting Wolf's Gravestone / Song of Broken Pines buffs for Sub DPSes, while also granting more Shield Bonus for better Shield uptime. A shielder is required for this, with Zhongli being the most ideal option.

**[Serpent Spine](#weapon:serpent-spine)**<br>
At **\[C6\]** and high refinement Serpent Spine, it is better to run an ATK% Goblet over Physical Damage% with Serpent Spine. This is due to the oversaturation of damage bonuses (ascension stat + Serpent Spine) in addition to the fact that Electro accounts for a significant portion of Razor's damage. An in-depth explanation [can be found here](https://tinyurl.com/razoratk). **It is also worth noting that an \[R5\] Serpent Spine with max stacks can outperform all 5✩ weapons at \[R1\].**
...
[In-depth Guide](https://keqingmains.com/rosaria/) from KQM
...
At High refinement \[R4-R5\] this performs a tad better than [Primordial Jade Winged-Spear](#weapon:primordial-jade-winged-spear).<br>
...
**Regarding Substats**<br>

Rosaria does not need much Energy Recharge if paired with Kaeya. If paired with another Cryo unit such as Chongyun or Ayaka, she will need \~130-150% Energy Recharge<br>
...
**[Noblesse Oblige (4)](#artifact:noblesse-oblige)**
This set is only used in her sub-dps/quickswap roles not her perma-freeze dps role. Also it should only be considered when you have no decent Blizzard Strayer (4) pieces and no one else on the team is holding Noblesse Oblige (4).
...
Can be the better option in teams that prefer the Elemental Mastery buff over ATK, such as Hu Tao VapeMelt.
...
When used in its niche with aggravate teams it can outpeform [Katsuragikiri Nagamasa](#weapon:katsuragikiri-nagamasa). Outside of that its just a energy% stat stick.
...
The passive of this weapon works perfectly with Shenhe's Elemental Skill because it's dynamic. This weapon also has high Base ATK which makes ATK% substats really effective.

[Engulfing Lightning](#weapon:engulfing-lightning)<br>
This weapon provides Energy Recharge and converts Energy Recharge to ATK, which benefits Shenhe a lot.

[Vortex Vanquisher](#weapon:vortex-vanquisher)<br>
This weapon's passive can't be stacked off-field, but it's still an ATK stat stick which provides Shenhe with a lot of ATK.

[Favonius Lance](#weapon:favonius-lance)<br>
With this weapon, it is better to have some Crit Rate on Shenhe for the weapon passive to proc. (Do note that Cryo Resonance provides 15% Crit Rate on Cryo-imbued enemies, so the need for Crit Rate on Shenhe is lowered)
...
**[Lost Prayer to the Sacred Winds](#weapon:lost-prayer-to-the-sacred-winds)** 
In teams where Shikanoin Heizou and Bennett are used in the same team, this weapon is equal to Skyward Atlas.

**Regarding Artifact Sets**<br>
**[Viridescent Venerer (4)](#artifact:viridescent-venerer)**
...
**[Hakushin Ring](#weapon:hakushin-ring)**
In electro-charged teams, this can be used to buff both anemo and electro damage, and scales well with refines. It is recommended to run Anemo DMG based artifacts on this build.

**[Prototype Amber](#weapon:prototype-amber)**
In teams where there is no healer, Shikanoin Heizou can use this weapon to help the team's survivability.

**Regarding Artifact Sets**

**[Noblesse Oblige (4)](#artifact:noblesse-oblige) or [Instructors (4)](#artifact:instructor)**
Only use this set if you already have a [Viridescent Venerer (4)](#artifact:viridescent-venerer) user on your team.
...
When utilized as a [Viridescent Venerer (4)](#artifact:viridescent-venerer) artifact set holder, make sure you **don't immediately swap away** after casting Skill/Burst, you need to be on-field when the swirl reaction happens for you to trigger the 4-set effect.
...
[Favonius Codex](#weapon:favonius-codex)<br>
This weapon can be useful if you value the extra energy generation from the passive. You may need to get a few crit rate substats to trigger the passive reliably.

There are some team compositions in which Sucrose's Elemental Mastery is not a priority, such as Freeze teams or an Anemo battery for Xiao. In such situations it's better for Sucrose to use [Thrilling Tales of Dragon Slayers](#weapon:thrilling-tales-of-dragon-slayers).
...
**Optimal skill duration for \[C0\]:** 7s, 9s or 12s.<br>
...
**[The Stringless](#weapon:the-stringless)**
Main DPS Childe should only use this weapon in teams where you are Vaporising your Burst,** as the Elemental Mastery substat loses a lot of value in other teams. If Childe is being used as a Nuke Support only for his Vaporized Burst damage, R5 Stringless will rank just below Thundering Pulse. Note that the stringless elemental skill passive does not affect Childe's melee stance auto attacks.
...
**[Kitain Cross Spear](#weapon:kitain-cross-spear)** 
High refinement is recommended to further reduce Thoma's Energy Recharge requirements<br>

**[Dragon's Bane](#weapon:dragons-bane)** 
Becomes a more reasonable option when you have Thoma's C4.
...
[In-Depth Guide](https://keqingmains.com/tighnari/) by KQM
...
**[Elegy for the End](#weapon:elegy-for-the-end)**
If Tighnari does not need the Energy Recharge that Elegy provides, this weapon will perform worse than **Amos' Bow** for his personal damage.
...
[In-depth Guide](https://keqingmains.com/geo-traveler/) by KQM
...
**[Noblesse Oblige (4)](#artifact:noblesse-oblige)**<br>
This set focuses more on providing an ATK buff to the team than the Traveler's personal damage. It can be paired with a Favonius/Sacrificial Sword for the Traveler to provide more utility to the team.
...
Check out [this link](http://tinyurl.com/ventiburstinfo) to see which characters can hit the enemies sucked and ragdolled in Venti's burst.
...
**THIS LIST ASSUMES THAT XIANGLING IS RUN WITH BOTH BENNETT AND A SECONDARY BUFFER (i.e. Kazuha/Sucrose)**

[Wavebreaker's Fin](#weapon:wavebreakers-fin)<br>
\[R5\] Wavebreaker's Fin is equal to or outperforms Staff of Homa, depending on your total team burst cost.

[Dragon's Bane](#weapon:dragons-bane)<br>
\[R5\] Dragon's Bane outperforms Primordial Jade-Winged Spear.

[Kitain Cross Spear](#weapon:kitain-cross-spear)<br>
...
\[R5\] Lithic Spear with 2 stacks performs equal to Primordial Jade-Winged Spear.

[Favonius Lance](#weapon:favonius-lance)<br>
The utility provided from a highly refined Favonius Lance can make it a weapon of choice in a team comp where Xiangling is not triggering the reaction and is instead used as an aura. (i.e. Reverse Melt teams)

**Regarding Weapons and Artifacts with EM stat**

[Dragon's Bane](#weapon:dragons-bane) / [Kitain Cross Spear ](#weapon:kitain-cross-spear)**/ EM substats**<br>
In team comps where you can trigger both Vaporize and Overload at the same time (i.e. Raiden National), Elemental Mastery gets more value, pushing these weapons and artifacts ahead in damage.
...
[Crescent Pike](#weapon:crescent-pike)<br>
...
[Pale Flame (4)](#artifact:pale-flame)<br>
The passive from this set can have 100% uptime through using Guoba off cooldown.
...
**Best combo for Xiao when fighting a single target**<br>
Plunge -> Normal Attack -> Charged Attack -> Plunge

**Best combo for Xiao when fighting multiple enemies**<br>
...
**[20% Energy Recharge (2)](#artifact:20%-er) and [20% Energy Recharge (2)](#artifact:20%-er)**<br>
This set is a cheap beginner option to maintain burst uptime well since it gives 40% Energy Recharge. Note that it is not recommended to stay on this set as Xingqiu contributes a lot of damage in his teams.
...
**[Serpent Spine](#weapon:serpent-spine)**<br>
At \[R5\], this weapon performs better than [Skyward Pride](#weapon:skyward-pride).<br>

[The Unforged](#weapon:the-unforged)
This ranking is based on unshielded performance, while shielded this weapon performs better than low refinement Serpent Spine.<br>

[Prototype Archaic](#weapon:prototype-archaic)
At \[R5\], this weapon performs better than [Snow-Tombed Starsilver](#weapon:snow-tombed-starsilver) \[R5\].
...
≈ [Retracing Bolide (4)](#artifact:retracing-bolide)
...
**[Serpent Spine](#weapon:serpent-spine)**<br>
It is worth noting that an \[R5\] Serpent Spine can outperform [Redhorn Stonethresher](#weapon:redhorn-stonethresher) \[R1\] with good Serpent Spine stack management.<br>

**[Lithic Blade](#weapon:lithic-blade)**
This ranking assumes 2 stacks.

**Regarding Artifact Sets**

[Lavawalker (4)](#artifact:lavawalker)<br>
Xinyan can maintain a high pyro aura uptime on an enemy, making this her best set.
...
Xinyan's skill grants you a pyro status upon contact with shield. No matter how many times you switch your characters, it'll still apply pyro every instance you switch with shield. This allows you to cleanse most elemental statuses that has been applied to you.
...
**[Tenacity of the Millelith (4)](#artifact:tenacity-of-the-millelith)**<br>
If you can maximize the uptime of Xinyan's Level 3 shield, she can provide a constant 30% Shield Strength and 20% Atk boost to the team (as long as the pulses hit an enemy). This means that [Sacrificial Greatsword](#weapon:sacrificial-greatsword) and Xinyan's \[C2\] are crucial to making this set shine on her. This set isn't as recommended for her if you have neither of the two.
...
**[Tenacity of the Millelith (4)](#artifact:tenacity-of-the-millelith)**<br>
This set trades off a portion of Yae's damage in return for a party wide 20 ATK% buff. If you have good pieces as a result of farming Pale Flame (for Eula or otherwise) this can be a good option for her. Not recommended to specifically farm this set for Yae.

**Regarding Talent Priority**

Do note that Yae's Elemental Burst does more damage than her Elemental Skill when it hits multiple enemies, and in some setups requiring high ER its more efficient to simply ult every second rotation rather than try to stack enough ER substats.
...
**[Gilded Dreams (4)](#artifact:gilded-dreams)**<br>
Actually her BIS if used in a full Elemental Mastery build with a overload team.<br>
...
This ranking is assuming you're using either Yun Jin or Bennett in your team. While using both Yun Jin and Bennett, this weapon can potentially beat [Rust \[R5\]](#weapon:rust).
...
**[Rust](#weapon:rust)**
At \[R4\] this weapon performs better than [Polar Star](#weapon:polar-star), and at \[R5\] performs better than Aqua Simulacra.
...
Usable in Vaporize teams and can be her Best in Slot for teams where she procs Vaporize and Overload (such as teams with a Fischl flex or Fischl + Beidou taser core)
...
**[Retracing Bolide (4)](#artifact:retracing-bolide)**
This set is only recommended to be used with a shielder. This set is also very resin inefficient, so its not recommended to farm for this set specifically.
...
A good option if Yoimiya is **triggering Vaporize and/or Overload.** Having Bennett in the team favours Elemental Mastery sands slightly more than ATK sands, however it is recommended to just use whichever has better substats.
...
[Kitain Cross Spear](#weapon:kitain-cross-spear)<br>
Although the EM mainstat isn't useful for Yun Jin, the passive decreases her Energy Recharge requirements by alot, especially at higher refinements. It can reduce her ER% reqs from around \~20% at R1 to \~70% at R5.*Note that she must cast Elemental Burst first before Skill, as the passive drains 3 energy initially when Skill is cast. This weapon can be left at level 1 while still getting full effect from the passive.
