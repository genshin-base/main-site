...
[Краткое руководство](https://keqingmains.com/q/alhaitham-quickguide/) от ККМ
...
В некоторых отрядах через Стимуляцию ВЭ практически не требуется - Взрыв стихии используется каждую ротацию практически без потери урона.

Если у вас меньше 200 МС, то этот стат будет приоритетнее Крит. урона и шанса.
...
Взрыв стихии готов: Q > E > N2D + 2N3D + N1C + 2N2C

Без Взрыва стихии: E > N1C + 5N2C + N1

В руководстве по ссылке ротации рассматриваются более подробно.

*Q - Взрыв стихии, E - Элементальный навык, N - Обычная атака, D - Рывок, C - Заряженная атака


# === characters.#alhaitham.roles.#spread_dps.notes ===

Наилучшим образом раскрывает потенциал аль-Хайтама, так как урон и Разрастания, и Элементального навыка, и Взрыва стихии в значительной степени зависят от Мастерства стихий. Также преимущество даёт и его частое наложение Дендро. Все это в сочетании с гибкостью отрядов и ротаций делает его одним из лучших ДД от Разрастания на данный момент. Следует отметить, что большая часть урона аль-Хайтама приходится на Дендро реакции (особенно в отрядах через Стимуляцию/Разрастание), которые зависят от его уровня, поэтому рекомендуется возвышение до 90/90.

**О выборе оружия**
**Свет лиственного разреза**
С этим оружием предпочтительно использовать МС-часы даже без игры через Разрастание (команды через Бутонизацию/Вегетацию/Цветение)

**Токабо сигурэ**
Рейтинг применим к ситуациям боя с одиночными противниками, в АоЕ этот вариант уступает Стальному жалу и Черногорскому длинному мечу.

**Предвестник зари**
При постоянной работе Пассивной способности может соответствовать Харан гэппаку фуцу.

**Лунное сияние ксифоса / Осквернённое желание**
Могут соответствовать Чёрному мечу в отрядах с большей потребностью в ВЭ/при использовании Взрыва стихии каждую ротацию.

**О комплектах артефактов**

**Позолоченные сны (4)**
В топе рейтинга в случае, если в отряде есть носитель Воспоминаний дремучего леса. Если такового нет, то Воспоминания - лучший вариант для аль-Хайтама

**Воспоминания дремучего леса / Эмблема рассечённой судьбы (2) / +80 МС (2)**
Могут соответствовать Позолоченным снам или превосходить их при высокой потребности в ВЭ, желании использовать Взрыв стихии каждую ротацию, либо при наличии лучших сабстатов.

**О выборе главстатов**
Обычно в отрядах от Стимуляции/Стимуляции+Бутонизации аль-Хайтам обычно предпочитает МС-часы (превосходит иные примерно на 5%). Но в отрядах через Бутонизацию/Цветение/Вегетацию и минимумом Разрастания или вообще без такового часы на Силу атки% могут быть лучшим вариантом (кроме случаев использования Света лиственного разреза). Или даже часы на ВЭ%, если вам нужен Взрыв стихии каждую ротацию для увеличения количества бутонов.
...
Когда недостаточно других баффов на атаку, это оружие может соперничать с Чёрным мечом.
...
Хотя Беннет часто рассматривается как целитель, он хорошо лечит даже если не вкачивать его ХП, поэтому лучше собирать его в ульт. саппорта.
...
**[Стойкость Миллелита (4)](#artifact:tenacity-of-the-millelith)**
...
**Эмблема рассечённой судьбы (4)**
Обеспечивает наибольший личный урон Фарузан, если в отряде уже есть носитель Изумрудной тени. При фокусировке на ВЭ-допстатах превосходит Изгнанник (2) в качестве источника Восстановления энергии.
...
На **\[С6\]** Оз будет наносить 60% урона, поэтому, пока нет возможности собрать Бледный огонь (4) с Электро Кубком, можно использовать **+18% Силы атаки (2) и Громогласный рёв ярости (2).**
...
**[Усмиряющий гром (4)](#artifact:thundersoother)**<br>
Этот комплект артефактов превосходит +18% Силы атаки (2) Громогласный рёв ярости (2) в отрядах, где на противнике всегда наложено Электро, и является лучшим выбором в данном случае.
...
[Встречная комета (4)](#artifact:retracing-bolide) и [Странствующий ансамбль ](#artifact:wanderers-troupe) или[ Стойкость Миллелита (2) ](#artifact:tenacity-of-the-millelith) и 80 Мастерства стихий (2)<br>
...
На \[Р5\], эти оружия превзойдут Кромсателя пиков.
...
Рекомендуется повысить уровень Кэ Цин до 90
...
**[Позолоченные сны (4)](#artifact:gilded-dreams)**
В этом комплекте часы на Силу атаки могут быть полезнее часов на Мастерство стихий.
...
[Память о пыли](#weapon:memory-of-dust)<br>
Рейтинг сформирован с учётом, что Кли без щитовика в отряде. Будучи в отряде с щитовиком, даже с Чжун ли, урон Кли будет хуже, и будет сравним с [Небесным атласом](#weapon:skyward-atlas).
...
На одинаковом ранге пробуждения, Песнь странника лучше, чем Истории Додоко, но сравния \[Р5\] Истории Додоко и \[Р1-3\] Песнь странника, \[Р5\] Истории Додоко выигрывают. Обратите внимание, что бафф Беннета или Эпоса о драконоборцах плюс бафф комплекта Церемонии древней знати (4) может вывести Песнь странника и Солнечную жемчужину вперед Историй Додоко, даже при низком Ранге пробуждения.
...
Сборка предназначена для играющих через Бутонизацию команд, в которых именно Кокоми создает большую часть бутонов.
...
**[Церемониальный лук](#weapon:sacrificial-bow)**
Благодаря высокой Силе атаки и Восстановлению энергии, этот лук лучший из четырехзвездочных в отрядах, где Саре и другому Электро персонажу не хватает энергии.
...
Куки один из лучших Электро-персонажей для игры через Вегетацию.

**О выборе оружия**

**[Ключ Хадж-нисут](#weapon:key-of-khaj-nisut)**
Превосходит Стальное жало при \[С4\], когда появляется возможность активировать третий уровень Пассивной способности оружия из кармана. Также может дать больше Мастерства стихий, чем Клятва свободы, если артефакты имеют допстаты на ХП. Однако всего этого зачастую недостаточно, чтобы превзойти Лунное сияние ксифоса и Клятву свободы из-за их Пассивных способностей.

**[Токабо сигурэ](#weapon:toukabou-shigure)**
Аналогичный Стальному жалу вариант, так как Пассивная способность не влияет на урон Вегетации.
...
[Церемонией древней знати (2)](#artifact:noblesse-oblige) \[Любые два\]
...
**[Ключ Хадж-нисут](#weapon:key-of-khaj-nisut)**
На бумаге хороший вариант для Куки из-за высокого личного урона и баффов для отряда. Но в реальности, Куки для накопления баффа понадобится 2-3 ротации или долго находиться не в кармане, что приведет к падению урона команды.
...
**[Усмиряющий гром (4)](#artifact:thundersoother)**
Лучший комплект, если удаётся все время поддерживать Электро на противнике. Обычно для этого требуется три Электро персонажа в отряде, или же два Электро и один Анемо для Рассеивания Электро.
...
[Краткое руководство](https://keqingmains.com/q/layla-quickguide/) от ККМ
...
Цель сборки — создание максимально крепкого щита Лайле и, насколько это возможно, увеличение её урона.

**О выборе оружия**

**[Клятва свободы](#weapon:freedom-sworn)**
Неплохой выбор в тех отрядах, где Лайла может вызывать реакции.

**О комплектах артефактов**

**[Заблудший в метели (4)](#artifact:blizzard-strayer) и [Эмблема рассечённой судьбы](#artifact:emblem-of-severed-fate)**
Комплекты предназначены для увеличения личного урона Лайлы.
...
E (Быстрое нажатие) > NA x2 [до 3 уровней] > E (Долгое нажатие) > N2C. Повторять N2C до отката Элементального навыка, затем повторить цикл.

где N/NA = Обычная атака, C = Заряженная атака, E = Элементальный навык


# === characters.#lisa.roles.#aggravate_dps.notes ===

Этот билд использует сильные стороны Лизы: от её родного МС до частого наложения Электро статуса. Одновременно он снижает требования Лизы к ВЭ, ставя её как драйвера в отряд через Стимуляцию - что является лучшим для неё вариантом игры.

**О выборе оружия**<br>

Подробности можно увидеть [здесь](https://docs.google.com/spreadsheets/d/1kBaIxbNUUkShl-OwbOxMK4wyPQvL-WWeOko7yfWRIxw/edit#gid=601082040)<br>

**Песнь странника** 
На высоких Рангах пробуждения \[Р4-Р5\] начинает соответствовать Молитве святым ветрам..<br>

**Solar Pearl**
На высоких Рангах пробуждения \[Р4-Р5\] может соответствовать Небесному атласу или превосходить его, особенно с внешними источниками Силы атаки.

**Усмиряющий гром**<br>

**Усмиряющий гром (4)**
Может превосходить Позолоченные сны (4) в отрядах со стабильным поддержанием Электро статуса на противниках.
...
Только в отрядах Обострения и Разрастания
...
Сборка направлена на игру Лизой как источником бонусов/взрывного урона [значительный урон за короткое время] в револьверных отрядах, в особенности основанных на Стимуляции.

**О выборе оружия**<br>

**Истина кагура**
Рейтинг этого оружия основан на специфической ротации, но она отличается для карманного ДД. Последовательность выполняется E (короткое) > N2 > E (короткое) > Q > E (долгое) (3 уровня).

**Эпос о драконоборцах**
Вариант рекомендован как недорогая альтернатива. Используется в случае использования Лизы как персонажа поддержки, а не источника урона.

**О приоритетных статах**
Необходимо собрать достаточно ВЭ для использования Взрыва стихии по откату.
...
В МС-сборке повышение уровня талантов Лизы необязательно


# === characters.#lisa.roles.#em_dps.notes ===

МС Лиза нацелена на постоянный вызов реакций, как правило, Перегрузки или Вегетации (лучшие варианты при таком билде). Они вызываются в первую очередь её Взрывом стихии, поэтому важно обеспечить его использование по откату. Избегайте использования второго Электро персонажа при игре через Перегрузку, так как он может сбивать Пиро статус, необходимый Лизе.

**О выборе оружия**<br>

**Плод восполнения**
На высоких Рангах пробуждения соответствует Сновидениям тысячи ночей по урону и одновременно с этим увеличивает Восстановление энергии, что делает его более удобным вариантом.

**О комплектах артефактов**<br>

**Цветок потерянного рая (4)**
Лишь на 4-6% (в зависимости от отряда) превосходит Позолоченные сны (4) в Вегетации. Но домен с Позолоченными снами - более рациональное вложение смолы, так как одновременно содержит и Воспоминания дремучего леса.

**О приоритетных статах**
Старайтесь вкладываться как в МС, так и в ВЭ. Цель в том, чтобы собрать как можно больше МС, получая при этом достаточное количество ВЭ для использования Взрыва стихии по откату.
...
**Песнь странника**
На \[Р5\] соответствует \[Р1\] Истине кагура

**Солнечная жемчужина**
На \[Р5\] соответствует \[Р1\] Песни странника.

**О комплектах артефактов**

**Воспоминания дремучего леса (4)**
Лучший вариант, если нет иного носителя данного сета в отряде.


# === characters.#nahida.roles.#quicken_/_hyperbloom_/_burgeon.name ===

стимуляция, вегетация, цветение
...
При постоянной реализации Пассивной способности оружия превосходит \[Р1\] Песнь странника. Однако это нереально в большинстве случаев.

**Скитающаяся звезда**
Дает бонусы всей команде, в связи с чем может превосходить другие варианты.

**Морской атлас**
На \[Р5\] соответствует \[Р1\] Песни странника.

**Кольцо Хакусин**
Не лучший вариант для личного урона Нахиды, но полезен как способ увеличить урон отряда в целом.
...
В роли поддержки через Бутонизацию, Нилу должна использоваться в отряде только из Гидро и Дендро персонажей. Также крайне рекомендуется прокачать её до 90 уровня, чтобы увеличить её здоровье и, как следствие, урон бутонов.
...
Это оружие лучше, чем [Морской атлас](#weapon:mappa-mare), когда в отряде есть Электро персонаж.
...
**[Усмиряющий гром (4)](#artifact:thundersoother)**
Этот комплект лучше, чем набор [Архаичный камень (2)](#artifact:archaic-petra) [Эмблема рассечённой судьбы (2)](#artifact:emblem-of-severed-fate) когда на противнике всё время поддерживается Электро статус.<br>

**[Ступающий по лаве (4)](#artifact:lavawalker)**
Этот комплект лучше, чем набор [Архаичный камень (2)](#artifact:archaic-petra) [Эмблема рассечённой судьбы (2)](#artifact:emblem-of-severed-fate) когда на противнике всё время поддерживается Пиро статус.<br>
...
**+80 МС (2) и +80 МС (2)**
В отряде с другим Электро персонажем, разница между этим набором и полным комплектом Позолоченных снов примерно равна одному удачному роллу допстата. В отряде, где Райдэн единственный Электро персонаж, разница в 3-4 ролла допстата. Поэтому можно смело использовать этот набор.
...
Урон Взрыва стихии Райдэн зависит от стоимости Взрыва стихий членов отряда. Её взрыв Стихии восстанавливает большое количество энергии отряду. Это особенно полезно в командах, требующих много энергии и не конфликтующих с Электро, например с Эолой, в Электро-националке и так далее.

**О выборе оружия**

Список основывается на том, что Райдэн играется без баффера.
...
Главстаты кубка и часов зависят от допстатов, наличия внешнего баффера, используемого оружия.
...
Этот билд основан на том факте, что Элементальный навык и Взрыв стихии Розарии не имеют внутреннего таймера на вызов реакций, что позволяет ей вызывать реакцию на каждой атаке навыков. Сочетание этого и снапшотающих баффов, делает эту сборку самой сильной по урону.
...
**Смертельный бой**
Может превосходить все четырехзвездочные варианты и даже Нефритовый коршун при использовании с Позолоченными снами (4) против одиночного противника.

Подробнее [тут](https://docs.google.com/spreadsheets/d/1F8kvHkdRidPgQAFfxoX3iW6nr6WNIJI1F_5l3TJTkdE/edit#gid=144036677)
...
**Позолоченные сны (4)**
Значительно превосходит Эмблему рассеченной судьбы (4) в отрядах, где Розарии требуется 120% или менее ВЭ.
...
В ортяде «вечной заморозки», Розария играется в таком же отряде, как и Кэйа. Смотри примечания на его странице в разделе Крио ДД, если интересуют подробности построения отряда.
...
Розария получает много Шанса крит. попадания от комплекта Заблудшего в метели (4) и Крио резонанса. Поэтому это оружие не так ценно, ведь с ним Розария получает более 100% Шанса крит. попадания. Если Розария не использует комплект Заблудшего в метели (4), то это оружие может быть лучше других.
...
На Элементальном навыке и Взрыве стихии Розирии можно вызвать Реверсивное таяние Пиро персонажем, чтобы нанести больше урона.


# === characters.#rosaria.roles.#support.notes ===

В этой сборке Розария фокусируется на генерации энергии, накладывание Крио и баффах отряда. Но не стоит забывать и о её личном уроне, просто теперь он не основной приоритет.
...
Саю получает бонус урона от своего Мастерства стихий и бонус лечения от своей Силы атаки. Можно повысить лечение с помощью короны с Бонусом лечения, сохранив при этом приемлимый урон.Также Саю требуется большое количество Восстановления энергии, если она — единственный Анемо персонаж в отряде.
...
У Хэйдзо низкая потребность в Восстановлении энергии. С четвертым созвездием достаточно 100% ВЭ.
...
**[Кольцо Хакусин](#weapon:hakushin-ring)**
В игре через реакцию Заряжен это оружие будет увеличивать и Анемо, и Электро урон. С этим катализатором рекомндуется носить артефакты на Анемо урон.
...
**[Воспоминания Симэнавы (4)](#artifact:shimenawas-reminiscence)**<br>
Из-за того, что этот комплект требует иметь около 150% Восстановления энергии, чтобы все время активировать Взрыв стихии, он хуже других комплектов. Но он выше по урону, чем Сердце глубин (4), если сравнивать ротацию с одной ультой, и не собирать Восстановление энергии.

# === characters.#thoma.credits ===

[Подробное руководство](https://keqingmains.com/q/thoma-quickguide/) от ККМ (англ.)
...
Этот билд сфокусирован на вызове Томой реакции Цветение. Это хорошая роль для Томы, потому что он редко накладывает Пиро и, как следствие, не вызывает Горение. Кроме того, у Томы есть щит, который защищает его от нанесения урона самому себе.
...
**Инструктор(4)**
Лучший комплект для отрядов через реакции, например с Ху Тао через Испарение. Но из-за того что у комплекта нет легендарного уровня, становится намного сложнее собрать хорошие допстаты.
...
Существует три рекомендуемых комбо для Тигнари:
1. E -> Q -> CA (x3) — Самое простое, но также самое слабое комбо. Взрыв стихии не получает бонуса первого Пассивного таланта.
2. E -> CA (x3) -> Q — Первый Пассивный талант увеличивает урон Взрыва стихии. Однако частицы от его Элементального навыка не заряжают следующий Взрыв.
3. E -> CA -> Q -> CA (x2) — Самое технически сложное комбо; реализует первый Пассивный талант и позволяет заряжать Взрыв стихии для следующей ротации.
...
Предполагается, что на персонаже экипированы и часы, и кубок, и корона на Мастерство стихий, при этом Шанс крит. попадания и Крит. урон не очень важны. Если хочется играть через криты, то рекомендуется углубленное изучение [гайда (англ.)](https://keqingmains.com/venti/)
...
Взрыв стихии приоритетнее Элементального навыка, когда Странник С2\*\*
...
С [Хрониками Чертогов в пустыне (4)](#artifact:desert-pavilion-chronicle) и [Воспоминаниями Тулайтуллы](#weapon:tulaytullahs-remembrance): (Q) E CA N3x6<br>
Только с [Хрониками Чертогов в пустыне (4)](#artifact:desert-pavilion-chronicle): (Q) E CA N3x5 N2<br>
С другими комплектами артефактов: (Q) E N3x6 N2

Где E — Элементальный навык, N — Обычная атака, CA — Заряженная атака, Q — Взрыв стихии

# === characters.#wanderer.roles.#dps_(without_bennett).notes ===

Большая часть урона Странника — это усиленные за счет стойки Элементального навыка Обычные атаки. В этой стойке у него практически нет сопротивления к прерыванию, поэтому рекомендуется использовать щит или другую форму сопротивления. Сборка в ВЭ для использования Взрыва стихии каждую ротацию не рекомендована, вместо этого лучше использовать его каждую вторую ротацию.

**О выборе оружия**

**Память о пыли**
Может значительно превосходить другие варианты при наличии щита. Со щитом, но без Беннета сохраняет позицию в рейтинге; с Беннетом становится лучше Песни странника.

**Истории Додоко \[Р5\]**
Рекомендуемая ротация с этом оружием - E N1 CAx6 N1 CAx6, что отлично раскрывает Пассивную способность.

**Песнь странника**
Поскольку Странник не играет от Рассеивания, урон может быть неустойчив из-за шанса получить бонус МС.

**О комплектах артефактов**

**Отголоски подношения (4)**
Если пинг превышает 100, использование этого сета не рекомендовано.

**Заблудший в метели (4)**
Хорошо сочетается с 20% бонусом шанса крит.попадания при поглощении Крио. Рекомендуется использовать только при постоянном поддержании Заморозки, что требует очень специфичных отрядов. Но даже при постоянной Заморозке этот вариант хуже, чем Хроники чертогов в пустыне (4).

**Ступающий по лаве (4)**
Примерно соответствует Отголоскам подношения в отрядах с постоянным поддержанием Пиро на противниках.

**Изумрудная тень (4)**
Данный вариант может использоваться в отрядах, где большая часть урона наносится не Странником и нет другого носителя этого сета.
...
**Рекомендуемый порог Восстановления энергии**
...
**[Горящая алая ведьма (4)](#artifact:crimson-witch-of-flames)**<br>
Этот комплект может быть равен [Эмблеме рассечённой судьбы (4)](#artifact:emblem-of-severed-fate) в отрядах, где Сян Лин вызывает Перегрузку и Испарение (то есть Националка Райдэн).
...
**Хроники Чертогов в пустыне (4)**
Если Сяо использует оружие с низкой Базовой атакой и обильно получает Силу атаки% от отряда (Беннет, Эпосом о драконоборцах), комплект может соответствовать Киноварному загробью (4) или даже превосходить его.

Изумрудная тень (2) лучше второго комплекта на 18% Силы атаки, если у Сяо слишком много баффов на Силу атаки.
...
С6 означает, что у Син Цю есть шестое созвездие. Раздел С0-С5 посвящен игре на Син Цю без шестого созвездия.

**О выборе оружия**

Место в рейтинге предполагает, что Восстановления энергии достаточно для постоянного дейтсвия Взрыва стихии. Обычно это 150-170% Восстановления для [Церемониального меча](#weapon:sacrificial-sword). С другими оружиями нужно \~190% Восстановления. [Подробности для каждого меча (англ).](https://docs.google.com/spreadsheets/d/1wv1WXpkFkTX8SLCWLoQXlyxwnB2ZXZqQ6c9tSSVCAvQ/edit?usp=sharing)

**[Меч Фавония](#weapon:favonius-sword)**
Этот меч лучше, чем Церемониальный, в отрядах, где Син Цю единственный Гидро персонаж.
...
**[Предвестник зари \[Р5\]](#weapon:harbinger-of-dawn)**<br>
...
**[Деревянный клинок](#weapon:sapwood-blade)**
Следует использовать только в Дендро отрядах.
...
**[Эмблема рассечённой судьбы (4)](#artifact:emblem-of-severed-fate)**<br>
Не дает значительного бонуса урона, если Син Цю имеет менее 130% ВЭ.
...
Этот комплект хороший вариант для начинающих игроков, так как он дает 40% Восстановления энергии. Стоит обратить внимание, что в последствии комплект нужно сменить, потому что с ним Син Цю теряет в уроне.
...
[Ступающий по лаве (4)](#artifact:lavawalker)<br>
Синь Янь хорошо поддерживает Пиро на противнике, поэтому это лучший комплект для неё.
...
Если статус не был снят, следует переключиться на этого персонажа еще раз. Пиро плохо снимает Гидро эффект.
...
После трех ЭН обычно идет переключение на других персонажей для набора баффов, и лишь затем Взрыв стихии.
...
Элементальный навык в приоритете, если вы не планируете стоять на поле во время её Взрыва стихии.


# === characters.#yaoyao.roles.#support.tips ===

Юэгуи, вызываемые Взрывом стихии, исчезают, если Яо Яо уходит в карман.


# === characters.#yaoyao.roles.#support.notes ===

Текущий раздел в процессе написания.

Яо Яо фокусируется на лечении отряда и наложении Дендро за счет Элементального навыка и Взрыва стихии.

**О выборе оружия**

**Крест-копьё Китаин**
Превосходит Копьё Фавония в отрядах, где она вызывает Бутонизацию.

**О главстатах артефактов**

В команде, играющей от Бутонизации, где Яо Яо вызывает реакции, МС - предпочтительный вариант для основных статов артефактов.
...
карманный ДД и много ВЭ


# === characters.#yelan.roles.#high_energy_recharge_(off-field_dps).subStats.advices.1.notes ===

≈ шанс или урон Крит. удара


# === characters.#yelan.roles.#high_energy_recharge_(off-field_dps).notes ===

Роль Е Лань в отряде — из кармана накладывать Гидро на противников с помощью своего Взрыва стихии. Е Лань преимущественно скейлится от процента ХП, поэтому её не стоит билдить через силу атаки. Чтобы ультовать по откату, ей требуется много Восстановления энергии, вплоть до 250%. Это количество можно уменьшить Гидро персонажами или батарейками в отряде.

**О выборе оружия**

**[Элегия погибели](#weapon:elegy-for-the-end)**<br>
Это оружие стоит использовать только в отрядах основанных на реакциях. Личный урон Е Лань с этим оружием ниже, чем с другим оружием из этого списка, зато с ним выше урон команды. 

**[Луна Моун](#weapon:mouuns-moon)**<br>
Это оружие работает лучше на \[Р3+\] и делает кубок на процент ХП полезнее кубка на бонус Гидро урона, особенно в отрядах с сильным баффами силы атаки.

**Церемониальный лук**
В идеале должен быть \[Р3-Р5\] для лучшей синхронизации с отрядом.

**Аква симулякрум**
Хороший вариант, если нет проблем с Восстановлением энергии.

**Охотничья тропа / Полярная звезда / Громовой пульс**
Могут использоваться Е Лань, но она не раскроет полный потенциал этих луков. Лучше отдать их кому-то более подходящему.


**О главстатах артефактов**

**Кубок**
Кубок на процент ХП стоит использовать только если кубку на Гидро урон не повезло с допстатами, либо если Е Лань имеет сильные баффы силы атаки, например от [Эмблемы рассеченной судьбы (4)](#artifact:emblem-of-severed-fate) и Луны Моун, особенно с пробуждениями, или Райдэн с Казухой и так далее.

Не рекомендуется одновременно использовать более двух артефактов с главстатами на ХП.
...
карманный ДД и мало ВЭ


# === characters.#yoimiya.credits ===

[Подробный разбор](https://keqingmains.com/yoimiya/) от ККМ (англ.)
...
[Рогатка \[Р5\]](#weapon:slingshot)
Позиция в рейтинге основывается на том, что в отряде используется только кто-то один — Беннет или Юнь Цзинь. Если же они используются вместе, то это оружие может превзойти [Ржавый лук \[Р5\]](#weapon:rust).

[Лук Амоса](#weapon:amos-bow)
Позиция в рейтинге основывается на том, что бафф оружия реализуется не полностью, потому что Ёимия находится близко к противникам, чтобы не промахиваться своими атаками. Со всеми же стаками баффа, это оружие почти догоняет Рогатку \[Р5\]. Следует использовать Лук Амоса только если он уже прокаченный, и не хочется качать Рогатку.
...
Минусы этого комплекта делают его неподходящим для Ёимии. Для комфортной игры этот комплект требует пинг меньше 100 мс. Кроме этого, из-за того, что бонус комплекта активируется в случайный момент, нет гарантии, что бонус сработает на первую, третью или пятую атаки Ёимии — а это её атаки с наивысшим уроном и возможностью реакций. 
...
Элементальный навык скейлится очень слабо, поэтому он имеет самый низкий приоритет. Её Взрыв стихии имеет низкий приоритет, потому что в некоторых сценариях он используется редко, например с комплектом [Воспоминания Симэнавы](#artifact:shimenawas-reminiscence). Обычная атака имеет первоочередный приоритет потому, что это основной источник урона Ёимии. 
...
**О статах артефактов**<br>
Шанс крит. удара важен только с Копьём Фавония.
...
**Архаичный камень (4)**
Может быть полезным в отрядах, где не полезны баффы на Силу атаки, или где уже есть кто-то с комплектом Стойкость Миллелита. Комплект не очень удобный в использовании на Чжун Ли, потому что для работы баффа нужно будет подобрать им кристалл.

**Воспоминания дремучего леса (4)**
Хороший комплект для Дендро-отрядов, где основным дд-персонажам для большего урона оптимальнее использовать другие артефакты. Для баффа комплекта нужно чтобы колонна Чжун Ли регулярно наносила урон противникам, что может быть сложным Без Анемо-стяжки.

**Инструктор (4)**
Так как щит Чжун Ли достаточно крепкий даже при недоборе статов, этот комплект часто использовуется в отрядах, основанных на реакциях, например с Гань Юй через таяние или Ху Тао через пар.
