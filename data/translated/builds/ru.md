...
Следует всегда использовать Взрыв стихии Аято перед использованием его Элементального навыка, чтобы увеличить наносимый урон. Для этого нужно собрать достаточное количество Восстановления энергии, точное значение которого зависит от отряда. 
...
**О выборе оружия**
**[Харан гэппаку фуцу](#weapon:haran-geppaku-futsu) и [Драгоценный омут](#weapon:primordial-jade-cutter)**<br>
Если на Аято любой другой комплект кроме [Отголосков подношения (4)](#artifact:echoes-of-an-offering), то Драгоценный омут лучше, чем Харан гэппаку фуцу. В комплекте Отголоски подношения (4) и с пингом меньше ста, Харан гэппаку фуцу лучше, чем Драгоценный омут.

**[Небесный меч](#weapon:skyward-blade) и [Амэнома Кагэути](#weapon:amenoma-kageuchi)**<br>
При большом количестве Восстановления энергии в допстатах артефактов, или в отрядах где Аято требуется меньше 140% Восстановления энергии, это оружие теряет ценность.
...
В командах построенных через реакцию Заряжен, этот меч лучше, чем [Чёрный меч](#weapon:the-black-sword).
...
Этот комплект предпочтительнее, чем [Конец гладиатора](#artifact:gladiators-finale), если вы можете ультовать в нём по откату.
...
Базовый урон Куки Шинобу слишком низок, поэтому создание классической сборки на криты обычно не стоит вложений. Вместо него, для команд где Шинобу может постоянно вызывать реакции, например, Перегрузку, можно рассматривать билд на Мастерство стихий.
...
Этот лук лучше [Охотничьей тропы](#weapon:hunters-path), если Тигнари нужно больше 160% Восстановления энергии для постоянного использования Взрыва стихии. Полезность лука падает, если у кого-то другого в отряде уже есть Элегия погибели.
...
Хоть этот набор и хуже по урону, чем остальные варианты, на нем легко собрать хорошие допстаты.
