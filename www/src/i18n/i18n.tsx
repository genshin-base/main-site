...
export const I18N_CHANGE = { en: 'change', ru: 'изменить' }[LANG]
export const I18N_REGION = { en: 'Region', ru: 'Регион' }[LANG]
export const I18N_HOME = { en: 'Home', ru: 'Главное' }[LANG]
export const I18N_SEARCH = { en: 'Search', ru: 'Поиск' }[LANG]
export const I18N_SELECT_REGION = { en: 'Choose server region', ru: 'Выберите нужный сервер' }[LANG]
