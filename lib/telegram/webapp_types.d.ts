...
export interface EventMap {
   ...
   */
  popupClosed: { button_id: ButtonId | null }
  /**
...
export interface WebApp {
   ...
   */
  showPopup(params: PopupParams, callback?: (button_id: ButtonId) => unknown): void
  /**
...
export interface CloudStorage {
   ...
   */
  getItems(keys: string[], callback: (err: Error | null, values: string[]) => unknown): void
  /**
