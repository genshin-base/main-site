...
/** @typedef {ArtifactInfo & {name:string, rarity:import('#lib/genshin').GI_RarityCode, recommendedTo:string[]}} ArtifactFullInfo */
...
export function makeArtifactFullInfo(artifact, code2artifactData, characters, lang) {
	...
	return Object.assign({ name, rarity, recommendedTo: Array.from(recommendedTo) }, artifact)
}
