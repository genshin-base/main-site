...
import { getCodeChecked, nameOrCode, parseNotesLine } from './common.js'
...
/** @typedef {WeaponInfo & {name:string}} WeaponFullInfo */
 ...
 */
export function makeWeaponFullInfo(weapon, langNames, lang) {
	let name = nameOrCode(weapon, langNames, lang)
	return Object.assign({ name }, weapon)
}
