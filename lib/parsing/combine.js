...
/**
 * @param {import('./helperteam/types').CharacterBuildInfo<'monolang'>[]} buildCharacters
...
/**
 * @param {import('./helperteam/types').CharacterBuildInfo<'monolang'>} characterInfo
...
/**
 * @param {import('./helperteam/types').ArtifactInfo<'monolang'>[]} artifactInfos
 * @param {import('#lib/parsing').Code2ArtifactSetData} code2artifact
 * @param {import('#lib/parsing').Code2CharacterData} code2character
 * @param {import('#lib/parsing').Code2DomainData} code2domain
 * @param {import('#lib/parsing').Code2EnemyData} code2enemy
 * @param {import('./helperteam/types').CharacterBuildInfo<'monolang'>[]} characters
 * @param {string} lang
...
/**
 * @param {import('./helperteam/types').WeaponInfo<'monolang'>[]} weaponInfos
...
/**
 * @param {import('./helperteam/types').ArtifactInfo<'monolang'>} artifact
 * @param {import('#lib/parsing').Code2CharacterData} code2character
 * @param {import('#lib/parsing').Code2ArtifactSetData} code2artifact
 * @param {import('#lib/parsing').Code2DomainData} code2domain
 * @param {import('#lib/parsing').Code2EnemyData} code2enemy
 * @param {import('./helperteam/types').CharacterBuildInfo<'monolang'>[]} charactersInfo
 * @param {string} lang
...
/**
 * @param {import('./helperteam/types').WeaponInfo<'monolang'>} weapon
