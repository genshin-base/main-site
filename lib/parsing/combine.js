 ...
 */
export function makeCharacterFullInfo(characterInfo, common, artifacts, weapons, artGroupCodes, lang) {
...
/**
 * @param {CommonData} common
 * @param {Map<string, {code:string, count:number}[]>} recomArt2characters
 * @param {string} lang
 * @returns {ArtifactRegularInfo[]}
 */
export function makeArtifactsRegularInfo(common, recomArt2characters, lang) {
	return Object.values(common.code2artifact).map(x =>
		makeArtifactRegularInfo(x, common, recomArt2characters, lang),
	)
}
/**
 ...
 */
export function makeArtifactFullInfoWithRelated(artifact, common, recomArt2characters, lang) {
	const { code2domain, code2enemy } = common

	const artifactInfo = makeArtifactFullInfo(artifact, common, recomArt2characters, lang)
 ...
 */
export function makeWeaponsRegularInfo(common, recommendedWeaponCode2charCodes, lang) {
	return Object.values(common.code2weapon).map(x =>
		makeWeaponRegularInfo(x, recommendedWeaponCode2charCodes, common.code2character, lang),
	)
}
/**
 ...
 */
export function makeWeaponFullInfoWithRelated(weapon, common, recommendedWeaponCode2charCodes, lang) {
