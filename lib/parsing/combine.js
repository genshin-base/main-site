...
export function makeArtifactsFullInfo(
	...
	const fullArtifacts = Object.values(code2artifact).map(x =>
		makeArtifactFullInfo(x, code2character, code2domain, code2enemy, characters, lang),
	)
 ...
 */
function makeArtifactFullInfo(artifact, code2character, code2domain, code2enemy, charactersInfo, lang) {
