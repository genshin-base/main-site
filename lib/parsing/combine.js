 ...
 * @param {string} lang
 * @returns {ArtifactsRegularInfoWithRelated}
 */
export function makeArtifactsRegularInfo(
	...
	const artifactInfos = Object.values(code2artifact).map(x =>
 ...
 * @param {import('./helperteam/types').CharacterBuildInfo<'multilang'>[]} characters
 * @param {string} lang
 * @returns {WeaponsRegularInfoWithRelated}
 */
export function makeWeaponsRegularInfo(
	code2weapon,
	code2character,
	code2domain,
	code2item,
	...
	const weaponInfos = Object.values(code2weapon).map(x =>
		makeWeaponRegularInfo(x, recomWeap2characters, code2character, lang),
	)
	const rels = {
		items: /**@type {Map<string, ItemShortInfo>}*/ (new Map()),
		domains: /**@type {Map<string, DomainShortInfo>}*/ (new Map()),
