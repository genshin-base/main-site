...
/** @typedef {{code:string, name:string, obtainSources:{domainCodes:string[], enemyCodes:string[]}}} ItemObtainInfo */
...
export function makeCharacterFullInfo(
	...
	const rels = {
		items: /**@type {Map<string, ItemObtainInfo>}*/ (new Map()),
 ...
 * @param {string} lang
 * @returns {ItemObtainInfo}
 */
function makeItemObtainInfo(code, code2item, obtainSources, lang) {
...
function addItemWithRelated(rels, itemCode, code2item, code2domain, code2enemy, lang) {
	...
	const enemyCodes = rels.enemies
		...
		: []
	rels.items.set(itemCode, makeItemObtainInfo(itemCode, code2item, { domainCodes, enemyCodes }, lang))
}
