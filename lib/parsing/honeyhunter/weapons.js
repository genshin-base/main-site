...
import { searchNodeNodes } from '#lib/xml.js'
import {
	addLangItems,
	DUMMY_NODE,
	ensureSame,
				...
				(cells, colIndex, rowIndex) =>
					tryWithContext(`${type}-weapon`, 'skipping', null, setLogPrefix => {
						...
						if (id2material !== null) {
							...
							searchNodeNodes(cells[colIndex.material], node => {
						...
						return { type, id, name, rarity, primaryMaterialGroupCode, img }
					}),
			)
		}
