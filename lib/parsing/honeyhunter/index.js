 ...
 * @param {string[]} langs
 * @param {import('./fixes').HoneyhunterFixes} fixes
 * @returns {Promise<{items:import('#lib/parsing').WeaponsInfo, imgs:Code2ImageUrl}>}
 */
export async function extractWeaponsData(cacheDir, langs, fixes) {
	 ...
	 * }} WeaponLang
	 */
	const id2weapon = /**@type {IdLangMap<WeaponLang>} */ (new Map())
	const id2upcoming = /**@type {IdLangMap<WeaponLang>} */ (new Map())
