...
/** @typedef {{refs:SimilarWeaponRefs[]} & import('./common').BottomNotes} WeaponRefs */
...
export function extractWeaponRefs(lines, code2weapon, characterCode, fixes) {
	const weaponRefs = /**@type {WeaponRefs}*/ ({ refs: [], notes: null, seeCharNotes: false })
	...
	for (let line of lines) {
		...
		if (m) {
			...
			parseNotesLine(line, weaponRefs)
		}
	}
