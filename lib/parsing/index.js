...
/** @typedef {{code:string, name:Record<string,string>, rarity:import("#lib/genshin").GI_RarityCode}} ArtifactData */
 ...
 */
/** @typedef {Record<string,WeaponMaterialData>} Code2CharacterMaterialData */
