...
import { extractArtifactRefsGroups } from './artifacts.js'
 ...
 *   mainStats: OneOrMoreTextNodes,
 *   subStats: OneOrMoreTextNodes,
			...
			if (firstCellText && firstCellText.match(/^notes/i)) {
				...
				if (roleName !== '') {
					...
					const role = {
						...
						mainStats: json_extractText(cells[charBlock.ext.mainStatsCol]),
						subStats: json_extractText(cells[charBlock.ext.subStatsCol]),
